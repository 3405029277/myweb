...
for (const file of ["index.html", "post.html", "comments.html"]) {
  ...
  assert.match(html, /assets\/music-player\.js\?v=1/, `${file} should load versioned music player script`);
}
...
assert.match(musicJs, /assets\/music\/background\.mp3/, "music player should default to local music asset path");
