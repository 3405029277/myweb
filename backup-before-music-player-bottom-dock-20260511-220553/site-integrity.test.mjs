...
for (const file of ["index.html", "post.html", "comments.html"]) {
  ...
  assert.match(html, /assets\/music-player\.js\?v=3/, `${file} should load versioned music player script`);
}
...
assert.match(musicCss, /\.site-music-player\s*\{[\s\S]*left:\s*0/, "music player should dock to the side");
